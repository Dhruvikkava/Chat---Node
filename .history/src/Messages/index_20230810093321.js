...
io.on('connection', (socket) => {
  ...
  socket.on('joinRoom', async(roomData) => {   
    try {
        ...
        let chaeckUserJoined = await chatRooms.aggregate([
        ...
        console.log("fffff",JSON.stringify(chaeckUserJoined))
        if(checkUserJoined){
            console.log("ddddf",checkUserJoined.room_id.unique_room_id)
            // socket.join(checkUserJoined.room_id.unique_room_id);
        }else{
